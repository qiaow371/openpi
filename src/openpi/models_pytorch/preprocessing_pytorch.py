...
def preprocess_observation_pytorch(
    ...
    *,
    ...
    return SimpleProcessedObservation(
        ...
        tokenized_subtask_ce=getattr(observation, "tokenized_subtask_ce", None),
        tokenized_subtask_ce_mask=getattr(observation, "tokenized_subtask_ce_mask", None),
        tokenized_subtask_ce_labels=getattr(observation, "tokenized_subtask_ce_labels", None),
    )
