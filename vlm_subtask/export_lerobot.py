...
def build_agibot_episodes(rows: list[dict], *, task_id: str) -> list[dict]:
        ...
        episodes.append(
            {
                ...
                "init_scene_text": "",
                "label_info": {"action_config": action_config, "key_frame": []},
...
def export_from_compose(compose_dir: Path, repo_root: Path) -> dict:
    ...
    episodes = build_agibot_episodes(rows, task_id=task_id)
