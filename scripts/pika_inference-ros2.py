...
class RosOperator(Node):
    ...
    def model_inference(self):
        ...
        end_pose0 = [[0.2315508867606016, -2.365701964007318e-06, 0.1086502962013508, -5.032693615049478e-06, 0.3140743375720001, -1.2025435587192976e-05, 0.098] for _ in range(len(self.args.arm_end_pose_ctrl_topics))]
        end_pose1 = [[0.2315508867606016, -2.365701964007318e-06, 0.1086502962013508, -5.032693615049478e-06, 0.3140743375720001, -1.2025435587192976e-05, 0.0] for _ in range(len(self.args.arm_end_pose_ctrl_topics))]
