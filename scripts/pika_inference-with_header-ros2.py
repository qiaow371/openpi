...
def inference_process(args, t, ros_operator, policy):
    ...
    name_map = {
        "headerDepthCamera" : "base_0_rgb",
        "pikaDepthCamera_l" : "left_wrist_0_rgb",
        "pikaDepthCamera_r" : "right_wrist_0_rgb",
    }
    images = {}
...
class RosOperator(Node):
    ...
    def model_inference(self):
        ...
        end_pose0 = [[0.21600282640263135, 0.018892540126059044, 0.2347618748411257, 0.09036844628611339, 0.6095507376658058, 0.08208424138027613, 0.098] for _ in range(len(self.args.arm_end_pose_ctrl_topics))]
        end_pose1 = [[0.21600282640263135, 0.018892540126059044, 0.2347618748411257, 0.09036844628611339, 0.6095507376658058, 0.08208424138027613, 0.0] for _ in range(len(self.args.arm_end_pose_ctrl_topics))]
...
def get_arguments():
    ...
    # 服务器连接参数
    parser.add_argument('--policy_server_host', action='store', type=str, default='127.0.0.1', help='Policy server host')
    ...
    parser.add_argument('--camera_color_names', action='store', type=str, help='camera_color_names',
                        default=['pikaDepthCamera_l', 'headerDepthCamera', 'pikaDepthCamera_r'],#, 'pikaFisheyeCamera_l', 'pikaFisheyeCamera_r'],
                        required=False)
    parser.add_argument('--camera_color_parent_frame_ids', action='store', type=str, help='camera_color_parent_frame_ids',
                        default=['camera_l_link', 'camera_h_link', 'camera_r_link'],#, 'camera_fisheye_l_link', 'camera_fisheye_r_link'],
                        required=False)
    parser.add_argument('--camera_color_topics', action='store', type=str, help='camera_color_topics',
                        default=['/camera_l/color/image_raw', '/camera_h/color/image_raw', '/camera_r/color/image_raw'],#, '/camera_fisheye_l/color/image_raw', '/camera_fisheye_r/color/image_raw'],
                        required=False)
    parser.add_argument('--camera_color_config_topics', action='store', type=str, help='camera_color_config_topics',
                        default=['/camera_l/color/camera_info', '/camera_h/color/camera_info', '/camera_r/color/camera_info'],#, '/camera_fisheye_l/color/camera_info', '/camera_fisheye_r/color/camera_info'],
                        required=False)
    parser.add_argument('--camera_depth_names', action='store', type=str, help='camera_depth_names',
                        default=['pikaDepthCamera_l', 'headerDepthCamera', 'pikaDepthCamera_r'],
                        required=False)
    parser.add_argument('--camera_depth_parent_frame_ids', action='store', type=str, help='camera_depth_parent_frame_ids',
                        default=['camera_l_link', 'camera_h_link', 'camera_r_link'],
                        required=False)
    parser.add_argument('--camera_depth_topics', action='store', type=str, help='camera_depth_topics',
                        default=['/camera_l/aligned_depth_to_color/image_raw', '/camera_h/aligned_depth_to_color/image_raw', '/camera_r/aligned_depth_to_color/image_raw'],
                        required=False)
    parser.add_argument('--camera_depth_config_topics', action='store', type=str, help='camera_depth_config_topics',
                        default=['/camera_l/aligned_depth_to_color/camera_info', '/camera_h/aligned_depth_to_color/camera_info', '/camera_r/aligned_depth_to_color/camera_info'],
                        required=False)
    ...
    parser.add_argument('--camera_point_cloud_topics', action='store', type=str, help='camera_point_cloud_topics',
                        default=['/camera_l/depth/color/points', '/camera_h/depth/color/points', '/camera_r/depth/color/points'],
                        required=False)
    ...
    parser.add_argument('--arm_joint_state_topics', action='store', type=str, help='arm_joint_state_topics',
                        default=['/joint_states_single_gripper_l', '/joint_states_single_gripper_r'],
                        required=False)
    ...
    parser.add_argument('--robot_base_vel_ctrl_topic', action='store', type=str, help='robot_base_vel_ctrl_topic',
                        default='/cmd_vel',
                        required=False)
    parser.add_argument('--gripper_offset', nargs='+', action='store', type=float, help='gripper_offset', default=[-0.005, -0.005], required=False)
    ...
    parser.add_argument('--arm_base_link_in_world', action='store', type=float, help='arm_base_link_in_world', default=[[0, 0, 0, 0, 0, 0], [0, -0.6, 0, 0, 0, 0]], required=False)
