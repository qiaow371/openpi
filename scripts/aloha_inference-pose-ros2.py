...
class RosOperator(Node):
    ...
    def model_inference(self):
        ...
        end_pose0 = [[0.245, 0, 0.230, 0, 0, 0, 1.6] for _ in range(len(self.args.arm_end_pose_ctrl_topics))]
        end_pose1 = [[0.0545, 0, 0.230, 0, 0, 0, 0.0] for _ in range(len(self.args.arm_end_pose_ctrl_topics))]
